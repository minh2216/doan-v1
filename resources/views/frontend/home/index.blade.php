                    ...
                    <form action="#">
                        ...
                        <div class="rt-input-group">
                            <div class="single-input  col-rt-in-3">
                                ...
                                <span class="input-iconbadge"><img src="{{asset('public/assets/frontend/images/icons-image/s_icon_1.png')}}" alt="" draggable="false"></span>
                            </div><!-- /.single-input -->
                            <div class="single-input  col-rt-in-3">
                                ...
                                <span class="input-iconbadge"><img src="{{asset('public/assets/frontend/images/icons-image/s_icon_2.png')}}" alt="" draggable="false"></span>
                            </div><!-- /.single-input -->
                            <div class="single-input  col-rt-in-3">
